  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80 rounded-chip",
        ghost: "hover:bg-accent hover:text-accent-foreground rounded-md",
        link: "text-primary underline-offset-4 hover:underline rounded-none",
        // Auth-specific variants using design system
        auth: "bg-ti-black text-ti-white hover:bg-ti-grey-900 active:bg-ti-grey-800 rounded-button font-semibold shadow-sm hover:shadow-md",
        authSecondary: "bg-ti-white text-ti-black border-2 border-ti-grey-200 hover:border-ti-black hover:bg-ti-grey-50 rounded-chip",
        authGhost: "bg-transparent text-ti-grey-600 hover:text-ti-black hover:bg-ti-grey-50 rounded-md",
      },
      size: {
