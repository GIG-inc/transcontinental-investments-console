...
export const AuthLayout = ({
  ...
  return <div className="min-h-screen flex flex-col md:flex-row">
      ...
      duration: 0.6,
      ease: [0.2, 0.8, 0.2, 1]
    }} className="auth-split-left w-full md:w-3/5 min-h-[40vh] md:min-h-screen flex flex-col justify-center items-center p-8 md:p-16" style={{
      ...
      backgroundPosition: 'center'
        ...
        <div className="max-w-2xl w-full">
          ...
          ease: [0.2, 0.8, 0.2, 1]
            ...
            <img src={logoWhite} alt="Transcontinental Investments" className="h-80 md:h-16 w-auto shadow-xl object-cover" />
          </motion.div>
      ...
      {/* Right Column - 40% on desktop, full width on mobile */}
      <motion.div initial={{
      opacity: 0,
      x: 24
    }} animate={{
